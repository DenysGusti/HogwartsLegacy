...
import a12226166.MagicEffectRealization;
import a12226166.MagicItem;
...
class MagicItemTest {
    ...
    @Test
    void constructor() {
        Assertions.assertDoesNotThrow(() -> new MagicItemTestClass("Potion", 0, 0, 0));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new MagicItemTestClass("", 10, 1, 1));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new MagicItemTestClass(null, 10, 1, 1));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new MagicItemTestClass("a", -1, 1, 1));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new MagicItemTestClass("a", 10, -1, 1));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new MagicItemTestClass("a", 10, 1, -1));
    }
    ...
    @Test
    void usageString() {
        var bigger = new MagicItemTestClass("a", 2, 1, 1);
        var smaller = new MagicItemTestClass("a", 0, 1, 1);
    ...
    @Test
    void testToString() {
        var bigger = new MagicItemTestClass("Bigger", 2, 2, 2);
        var smaller = new MagicItemTestClass("Smaller", 0, 0, 2);
    ...
    void takeDamagePercent() {
        var bigger = new MagicItemTestClass("a", 10, 1, 1);
