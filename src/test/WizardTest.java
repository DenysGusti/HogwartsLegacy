...
class WizardTest {
    ...
    @Test
    void constructor() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Wizard(null, MagicLevel.NOOB,
                10, 10, 50, 50, 10, new HashSet<>(Collections.singleton(fireball)),
                new HashSet<>(Collections.singleton(fireball)), 10, new HashSet<>()));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Wizard("", MagicLevel.NOOB,
                10, 10, 50, 50, 10, new HashSet<>(Collections.singleton(fireball)),
                new HashSet<>(Collections.singleton(fireball)), 10, new HashSet<>()));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Wizard("a", null,
                10, 10, 50, 50, 10, new HashSet<>(Collections.singleton(fireball)),
                new HashSet<>(Collections.singleton(fireball)), 10, new HashSet<>()));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Wizard("a", MagicLevel.NOOB,
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Wizard("a", MagicLevel.NOOB,
                ...
                new HashSet<>(Collections.singleton(fireball)), 10, new HashSet<>()));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Wizard("a", MagicLevel.ADEPT,
                10, 10, 50, 50, 10, new HashSet<>(Collections.singleton(fireball)),
                new HashSet<>(Collections.singleton(fireball)), 10, new HashSet<>()));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Wizard("a", MagicLevel.NOOB,
    ...
    void castRandomSpell() {
        var clone = new Wizard("Clone", MagicLevel.ADEPT, 100, 3, 100, 3, 100,
    ...
    @Test
    void loot() {
        var deaddude = new Wizard("Dead Dude", MagicLevel.ADEPT, 100, 3, 100, 3, 100,
                new HashSet<>(), new HashSet<>(Collections.singleton(poison)),
                12, new HashSet<>());
