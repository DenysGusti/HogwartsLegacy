...
class HealthPotionTest {
    ...
    @Test
    void constructor() {
        Assertions.assertDoesNotThrow(() -> new HealthPotion("Potion", 10, 1, 1, 0));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new HealthPotion("Potion", 10, 1, 1, -1));
    }
