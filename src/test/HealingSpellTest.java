...
class HealingSpellTest {
    ...
    @Test
    void constructor() {
        Assertions.assertDoesNotThrow(() -> new HealingSpell("a", 3, MagicLevel.NOOB, false, false, 0));
        Assertions.assertDoesNotThrow(() -> new HealingSpell("a", 3, MagicLevel.NOOB, false, false, 101));
        Assertions.assertDoesNotThrow(() -> new HealingSpell("a", 3, MagicLevel.NOOB, false, true, 0));
        Assertions.assertDoesNotThrow(() -> new HealingSpell("a", 3, MagicLevel.NOOB, false, true, 100));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new HealingSpell("a", 3, MagicLevel.NOOB, false, false, -1));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new HealingSpell("a", 3, MagicLevel.NOOB, false, true, -1));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new HealingSpell("a", 3, MagicLevel.NOOB, false, true, 101));
    }

    @Test
    void doEffect() {
        var dude = new Wizard("Dude", MagicLevel.NOOB, 10, 0, 50, 0,
