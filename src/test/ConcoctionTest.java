...
class ConcoctionTest {
    ...
    @Test
    void constructor() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Concoction("a", 10, 1, 1, -3, -10, null));
        Assertions.assertDoesNotThrow(() -> new Concoction("a", 10, 1, 1, -3, -10, new ArrayList<>()));
        Assertions.assertDoesNotThrow(() -> new Concoction("a", 10, 1, 1, 3, 10, new ArrayList<>()));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Concoction("a", 10, 1, 1, 0, 0, new ArrayList<>()));
        Assertions.assertDoesNotThrow(() -> new Concoction("a", 10, 1, 1, 3, 10, new ArrayList<>(Collections.singletonList(fireball))));
    }
    ...
    void additionalOutputString() {
        ...
        var tmp1 = new Concoction("a", 10, 1, 1, 1, 0, new ArrayList<>());
        var tmp2 = new Concoction("a", 10, 1, 1, 0, 1, new ArrayList<>());
        var tmp3 = new Concoction("a", 10, 1, 1, -1, 1, new ArrayList<>(Collections.singletonList(fireball)));
        String out4 = tmp1.additionalOutputString();
        String out5 = tmp2.additionalOutputString();
        String out6 = tmp3.additionalOutputString();
        Assertions.assertEquals("; cast [" + fireball + "]", out1);
        ...
        Assertions.assertEquals("; -1 HP; +1 MP; cast [" + fireball + "]", out6);
    }

    @Test
    void useOn() {
        var dude = new Wizard("Dude", MagicLevel.NOOB, 3, 3, 50, 50,
