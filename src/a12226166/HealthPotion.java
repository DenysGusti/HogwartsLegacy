...
public class HealthPotion extends Potion {
    ...
    /**
     * returns "; +'health' HP". e.g. (total result of toString) "[Health Potion; 1
     * g; 1 Knut; 5 gulps; +10 HP]"
     *
     * @return "; +'health' HP"
     */
    @Override
    ...
    /**
     * If usages is greater than 0 reduce usages by 1 (tryUsage method) and increase
     * HP of target by health (call method heal(health))
     *
